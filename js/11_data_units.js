...
RoF.Data.UNITS = Object.freeze([
  ...
  {id:'fire_spirit', name:'불꽃정령', element:'fire', race:'spirit', role:'attack', rarity:'bronze', kind:'unit', dmgType:'melee', HP:1, ATK:1, NEED_SOUL:1, keywords:[], ability:'', desc:'꺼지기 전에 가장 뜨겁게 타오른다.', bundledSkillIds:['sk_firespirit_fireball','sk_firespirit_enchant','sk_firespirit_giant','sk_firespirit_self_destruct'], aiHint:'sac'},
